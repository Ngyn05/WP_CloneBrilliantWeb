...
<style>
  /* Mobile First Grid: Ảnh trên, Mô tả dưới */
  .product-visual-body-content .multiblock-grid,
  .product-visual-body-content .tw-grid,
  .product-visual-body-content [style*="grid-template-columns"],
  .multiblock .multiblock-grid,
  .gallery-container .tw-grid {
    display: grid !important;
    grid-template-columns: 1fr !important;
    gap: 16px !important;
  }
  .product-visual-body-content .tw-bg-darkBg {
    padding: 24px 18px !important;
  }
  .product-visual-body-content p.tw-text-\[30px\],
  .product-visual-body-content [style*="font-size: 24px"] {
