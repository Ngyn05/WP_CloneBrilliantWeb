...
<div class="blog blog--template--24820771684663__main main-section">
  <div class="container" data-aos="fade-up">
    <div class="blog__header">
      <h1 class="page-heading">
        Thông báo
          ...
          <a class="button <?php echo empty( $current_cat ) ? '' : 'button--secondary'; ?>" href="<?php echo esc_url( home_url( '/blogs/announcements/' ) ); ?>" title="Mới nhất">
            Mới nhất
          </a><a class="button <?php echo ( $current_cat === 'brilliant-labs-team' ) ? '' : 'button--secondary'; ?>" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/brilliant-labs-team/' ) ); ?>" title="Đội ngũ Brilliant Labs">
              Đội ngũ Brilliant Labs
            </a><a class="button <?php echo ( $current_cat === 'community' ) ? '' : 'button--secondary'; ?>" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/community/' ) ); ?>" title="Cộng đồng">
              Cộng đồng
            </a><a class="button <?php echo ( $current_cat === 'industry-updates' ) ? '' : 'button--secondary'; ?>" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/industry-updates/' ) ); ?>" title="Cập nhật ngành">
              Cập nhật ngành
            </a></div></div><?php if ( $blog_query->have_posts() ) : ?>
      <?php 
      $post_index = 0;
      $grid_open = false;
      ?>
      <?php while ( $blog_query->have_posts() ) : $blog_query->the_post(); $post_index++; ?>
        ...
        if ( ! $thumb_url ) {
            $thumb_url = get_template_directory_uri() . '/site-assets/cdn/shop/files/Artboard_1.jpg';
        }
        $post_link = home_url( '/blogs/announcements/' . $post->post_name . '/' );
        ?>

        <?php if ( $post_index === 1 && $paged == 1 ) : ?>
          <div class="row"><div class="col-12"><div class="article-card article-card--grid ">
            <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( $post_link ); ?>" title="<?php the_title_attribute(); ?>">
              <div class="row row--align-center"><div class="col-12 col-md-6">
                    <div class="article-card__image-wrapper image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="1280" height="720"></div>
                  </div><div class="article-card__content col-12 col-md-6 text-left"><p class="article-card__title h4 d-md-none"><?php the_title(); ?></p><p class="article-card__title h2 d-none d-md-block"><?php the_title(); ?></p><p class="article-card__excerpt">
                      <?php echo esc_html( wp_strip_all_tags( get_the_excerpt() ) ); ?>
                    </p><p><?php echo get_the_date( 'd/m/Y' ); ?>
        ...
        <?php else : ?>
          <?php if ( ! $grid_open ) : $grid_open = true; ?><div class="row"><?php endif; ?>
          <div class="col-12 col-md-4"><div class="article-card article-card--standard ">
            <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( $post_link ); ?>" title="<?php the_title_attribute(); ?>">
              <div class="row row--align-center"><div class="col-12 ">
                    <div class="article-card__image-wrapper image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="720" height="486"></div>
                  </div><div class="article-card__content col-12 text-left"><p class="article-card__title h4"><?php the_title(); ?></p><p class="article-card__excerpt">
                      <?php echo esc_html( wp_strip_all_tags( get_the_excerpt() ) ); ?>
                    </p><p><?php echo get_the_date( 'd/m/Y' ); ?>
          &nbsp;&mdash;&nbsp;<span class="underlined-link">
                        Đọc bài viết
      ...
      <?php if ( $grid_open ) : ?></div><?php endif; ?>

      <?php if ( $blog_query->max_num_pages > 1 ) : ?>
        <link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-pagination.css' ); ?>" rel="stylesheet" type="text/css" media="all">
        <div class="pagination-wrapper">
          <nav class="pagination" role="navigation" aria-label="Pagination">
            <ul class="pagination__list" role="list">
              <?php if ( $paged > 1 ) : ?>
                <li>
                  <a class="pagination__item pagination__item--prev pagination__item--no-hover" href="<?php echo esc_url( add_query_arg( 'paged', $paged - 1 ) ); ?>" aria-label="Previous page">
                    <svg class="icon icon-arrow-left-small" aria-hidden="true" focusable="false" role="presentation" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <?php for ( $i = 1; $i <= $blog_query->max_num_pages; $i++ ) : ?>
                <li>
                  <?php if ( $i == $paged ) : ?>
                    <a class="pagination__item pagination__item--current" role="link" aria-disabled="true" aria-current="page" aria-label="Page <?php echo $i; ?>"><?php echo $i; ?></a>
                  <?php else : ?>
                    <a class="pagination__item color-foreground" href="<?php echo esc_url( add_query_arg( 'paged', $i ) ); ?>" aria-label="Page <?php echo $i; ?>"><?php echo $i; ?></a>
                  <?php endif; ?>
                </li>
              <?php endfor; ?>
              ...
              <?php if ( $paged < $blog_query->max_num_pages ) : ?>
                <li>
                  <a class="pagination__item pagination__item--next pagination__item--no-hover" href="<?php echo esc_url( add_query_arg( 'paged', $paged + 1 ) ); ?>" aria-label="Next page">
                    <svg class="icon icon-arrow-right-small" aria-hidden="true" focusable="false" role="presentation" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <?php else : ?>
      <div class="row"><div class="col-12 text-center" style="padding: 60px 0;"><h3 style="color:#fff;">Chưa có bài viết nào trong danh mục này.</h3><p><a href="<?php echo esc_url( home_url( '/blogs/announcements/' ) ); ?>" class="button">Xem tất cả bài viết</a></p></div></div>
    <?php endif; ?>
  </div></div>
