...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-1-of-4/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
...
<div class="hero hero--template--24820771455287__article-hero hero--grid hero--mobile-small hero--image-right hero--has-logo   hero--share-button"><mobile-reversed-logo class="hero__logo text-center d-lg-none">
    ...
    </mobile-reversed-logo><div class="hero__image-overlay"></div><div class="hero__image-blur" data-hero-image-blur=""></div><div class="d-md-none"><img class="hero__background-image" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="928" height="751"></div>

  <div class="d-none d-md-block"><img class="hero__background-image" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="928" height="751"></div>
  ...
  <path d="M9 7H11L12 12H1L2 7H4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <div class="share-button__content">
      ...
      <input type="text" class="share-button__input d-none" id="url" value="<?php echo esc_url( get_permalink() ); ?>" placeholder="Liên kết" onclick="this.select();" readonly="" data-share-button-url-input="">
  ...
  <path d="M9 4H1V14H9V4Z" stroke="currentColor" stroke-linejoin="round"></path>
      ...
      </div><div class="col-12 col-md-6"><div class="hero__image-wrapper d-md-none"><img class="hero__image hero__image--small" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="928" height="751"></div>

            <div class="hero__image-wrapper d-none d-md-block"><img class="hero__image hero__image--small" src="<?php echo esc_url( $thumb_url ); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="928" height="751"></div>
          </div>
</div>
  </div>
