...
<div class="video-hero tw-relative tw-flex tw-h-[100svh] tw-w-screen tw-items-end tw-overflow-hidden">
  ...
  <path d="M9.5 1V11" stroke="currentColor" stroke-linecap="round"></path>
            ...
            <span class="play-icon d-none" style="display: none; align-items: center; justify-content: center;"><svg class="icon icon-play-small" aria-hidden="true" focusable="false" role="presentation" width="12" height="13" viewbox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M0.75 0.407715V12.4077L11.25 6.40771L0.75 0.407715Z" fill="currentColor"></path>
    ...
    <h1 class="video-hero--heading tw-text-2xl sm:tw-text-3xl md:tw-text-[50px] lg:tw-text-[60px] tw-flex tw-flex-wrap tw-justify-start tw-gap-x-4 md:tw-gap-x-6 tw-font-thin tw-tracking-wide">
      <span>Halo</span> <span>– Kính Thông Minh AI</span>
    </h1>
...
<div class="container specifications-container" style="padding-top: 60px; padding-bottom: 200">
  ...
  <div class="tw-mx-auto tw-grid tw-grid-cols-1 tw-gap-8 tw-px-3 md:tw-grid-cols-2 lg:tw-grid-cols-3">
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/avb33750d2192a3d27d91.png?v=1728384140&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/avb33750d2192a3d27d91.png' ); ?> 48w?v=1728384140&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/sensor.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/sensor.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Âm thanh
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/lens.svg?v=1728041438&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/lens.svg' ); ?> 48w?v=1728041438&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Tròng kính
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/cpu.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/cpu.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Bộ xử lý AI
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/camera.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/camera.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Cảm biến
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bluetooth.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bluetooth.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Kết nối
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/software.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/software.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Phần mềm
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/charger.svg?v=1727250176&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/charger.svg' ); ?> 48w?v=1727250176&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
          <div class="tw-pb-3 tw-text-lg tw-font-bold" style="color: #ffffff">
            Pin
          </div>
      ...
      <div class="specification-item tw-flex tw-items-start tw-gap-4"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/open-source.svg?v=1728383268&width=48' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/open-source.svg' ); ?> 48w?v=1728383268&amp;width=48 48w" width="48" height="48" loading="lazy" class="tw-w-12 tw-invert tw-pt-2">
<div class="tw-flex tw-flex-col tw-justify-center">
...
<featured-videos class="featured-videos featured-videos--desktop-carousel featured-videos--template--24820772274487__featured_videos_CHADzm color-scheme--default no-js-hidden" data-featured-videos="">
  ...
  <button class="video__button" type="button" aria-label="Load video: " data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2.gif?v=1761109353' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2.gif' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2-1.gif' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2-2.gif' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2-3.gif' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2-4.gif' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/SamAvatarSM_d5f7ddc3-6487-4721-b334-3434f28d1fb2-5.gif' ); ?> 720w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="720" height="480" style="object-position: 50.0% 50.0%;"></div>
...
<div class="container gallery-container" style="padding-top: 120px; padding-bottom: 72px">
  <div class="tw-grid tw-gap-8 md:tw-min-h-[325px] md:tw-grid-cols-1">
    ...
    <div class="tw-group tw-relative tw-flex tw-min-h-[0px] tw-flex-col  tw-justify-center   tw-rounded-standard tw-bg-darkBg tw-px-[37px] tw-pb-[37px] tw-pt-[47px] tw-overflow-hidden lg:tw-col-span-full"><div style="height: 160px"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/NoaWebsite.png?v=1753928860&width=690' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/NoaWebsite-1.png' ); ?> 352w?v=1753928860&amp;width=352 352w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/NoaWebsite.png' ); ?> 690wg?v=1753928860&amp;width=690 690w" width="690" height="291" loading="lazy" class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-object-cover tw-transition-transform">
</div>
...
<featured-videos class="featured-videos featured-videos--desktop-carousel featured-videos--template--24820772274487__featured_videos_BMw4Ge color-scheme--default no-js-hidden" data-featured-videos="">
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi.png?v=1757362979' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel.png?v=1769348954' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-7.png' ); ?> 1296w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1453" height="822" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="video__button" type="button" aria-label="Load video: " data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife.png?v=1757190597' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing.png?v=1757190120' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="video__button" type="button" aria-label="Load video: " data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date.png?v=1757190261' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n.png?v=1757190368' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="1" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi.png?v=1757362979' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/bulgogi-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Món Bulgogi là gì? 😱
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="2" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel.png?v=1769348954' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/babel-7.png' ); ?> 1296w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1453" height="822" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Dịch thuật thời gian thực khi đạp xe 🚲
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: " data-index="3" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife.png?v=1757190597' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/wife-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Hỗ trợ tập thể hình 💪
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="4" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing.png?v=1757190120' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/boxing-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Hướng dẫn kỹ thuật boxing 🥊
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: " data-index="5" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date.png?v=1757190261' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/date-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Nhận biết cây cọ chà là 🌴
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="6" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n.png?v=1757190368' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/garde3n-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="KÃ­nh thÃ´ng minh AI Halo" loading="lazy" width="1589" height="899" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Halo &amp; Noa | Trợ lý làm vườn thông minh 🧑‍🌾
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
...
<div class="container gallery-container" style="padding-top: 152px; padding-bottom: 120px">
  <div class="tw-grid tw-gap-8 md:tw-min-h-[325px] md:tw-grid-cols-3">
    ...
    <div class="tw-group tw-relative tw-flex tw-min-h-[0px] tw-flex-col  tw-justify-center   tw-rounded-standard tw-bg-darkBg tw-px-[37px] tw-pb-[37px] tw-pt-[47px] tw-overflow-hidden "><div style="height: 400px"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/IMG_1943.webp?v=1753758188&width=400' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/IMG_1943-1.webp' ); ?> 352w?v=1753758188&amp;width=352 352w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/IMG_1943.webp' ); ?> 400wp?v=1753758188&amp;width=400 400w" width="400" height="522" loading="lazy" class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-object-cover tw-transition-transform">
</div>
        <div class="tw-relative tw-flex tw-flex-col">
          <p class="tw-text-[16px] tw-pb-6 tw-text-white"></p>
          <p class="tw-text-[30px] tw-pb-10 tw-text-white tw-leading-[4rem]"></p>
    ...
    <div class="tw-group tw-relative tw-flex tw-min-h-[0px] tw-flex-col  tw-justify-center   tw-rounded-standard tw-bg-darkBg tw-px-[37px] tw-pb-[37px] tw-pt-[47px] tw-overflow-hidden "><div style="height: 400px"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_8.png?v=1753738731&width=400' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_8-1.png' ); ?> 352w?v=1753738731&amp;width=352 352w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_8.png' ); ?> 400wg?v=1753738731&amp;width=400 400w" width="400" height="400" loading="lazy" class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-object-cover tw-transition-transform">
</div>
        <div class="tw-relative tw-flex tw-flex-col">
          <p class="tw-text-[16px] tw-pb-6 tw-text-white"></p>
          <p class="tw-text-[30px] tw-pb-10 tw-text-white tw-leading-[4rem]"></p>
    ...
    <div class="tw-group tw-relative tw-flex tw-min-h-[0px] tw-flex-col  tw-justify-center   tw-rounded-standard tw-bg-darkBg tw-px-[37px] tw-pb-[37px] tw-pt-[47px] tw-overflow-hidden "><div style="height: 400px"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_4b.png?v=1753738731&width=400' ); ?>" alt="KÃ­nh thÃ´ng minh AI Halo" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_4b-1.png' ); ?> 352w?v=1753738731&amp;width=352 352w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Halo_4b.png' ); ?> 400wg?v=1753738731&amp;width=400 400w" width="400" height="400" loading="lazy" class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-object-cover tw-transition-transform">
</div>
        <div class="tw-relative tw-flex tw-flex-col">
          <p class="tw-text-[16px] tw-pb-6 tw-text-white"></p>
          <p class="tw-text-[30px] tw-pb-10 tw-text-white tw-leading-[4rem]"></p>
