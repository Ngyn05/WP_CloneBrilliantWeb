...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/developers/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
