<?php
/** Static interface converted from blogs/announcements/tagged/brilliant-labs-team.html */
...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/brilliant-labs-team/' ) ); ?>">
  ...
  <script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/theme-4ed993c7.js' ); ?>" type="module" crossorigin="anonymous"></script>
    ...
    <title>
      Thông báo
 &ndash; tagged "Brilliant Labs team" &ndash; Brilliant Labs</title>
...
<div class="blog blog--template--24820771684663__main main-section">
    ...
    <div class="blog__header">
      <h1 class="page-heading">
        Thông báo
          ...
          <a class="button button--secondary" href="<?php echo esc_url( home_url( '/blogs/announcements/' ) ); ?>" title="Mới nhất">
            Mới nhất
          </a><a class="button " href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/brilliant-labs-team/' ) ); ?>" title="Đội ngũ Brilliant Labs">
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-1-of-4/' ) ); ?>" title="Hành trình đến Halo | Phần 1">
    <div class="row row--align-center"><div class="col-12 col-md-6">
        ...
        </div><div class="article-card__content col-12 col-md-6 text-left"><p class="article-card__title h4 d-md-none">Hành trình đến Halo | Phần 1
</p><p class="article-card__title h2 d-none d-md-block">Hành trình đến Halo | Phần 1
...
&nbsp;&mdash;&nbsp;<span class="underlined-link">
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/hackathon-august-3rd-2024/' ) ); ?>" title="Hackathon: Ngày 3 tháng 8 năm 2024">
    <div class="row row--align-center"><div class="col-12 ">
        ...
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hackathon: Ngày 3 tháng 8 năm 2024
</p><p class="article-card__excerpt">
