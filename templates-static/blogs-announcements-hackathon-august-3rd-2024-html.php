...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/hackathon-august-3rd-2024/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
 ...
 &ndash; Brilliant Việt Nam</title><meta name="description" content="We had the pleasure of hosting a hackathon with Niantic, the creators of Pokémon Go! Over 50 developers from across the country—and even around the world—joined us to build applications at the intersection of AI and AR on Frame. Check out videos from the event below! Hackathon: Ngày 3 tháng 8 năm 2024 Playlist!">
