<?php
/** Static interface converted from pages/privacy-policy.html */
...
<meta property="og:description" content="BRILLIANT LABS - PRIVACY POLICY Date Last Updated: December 5, 2025 Brilliant Labs Pte. Ltd. (UEN: 202316146G), a company incorporated under the laws of Singapore (“Brilliant,” “Company,” “we,” “us,” or “our”), respects your privacy and is committed to safeguarding any information we collect from or about you. This Pri"><meta property="og:image" content="http://brilliant.xyz/cdn/shop/files/Halo_16_9e6dbe16-f264-4d22-bca1-175227d4ade6.png?v=1753981531">
...
<meta name="twitter:description" content="BRILLIANT LABS - PRIVACY POLICY Date Last Updated: December 5, 2025 Brilliant Labs Pte. Ltd. (UEN: 202316146G), a company incorporated under the laws of Singapore (“Brilliant,” “Company,” “we,” “us,” or “our”), respects your privacy and is committed to safeguarding any information we collect from or about you. This Pri">
<script>
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"68d14ef9-d6b5-4853-b941-4e42f54c1fde-1787126638","pageurl":"brilliant.xyz\/pages\/privacy-policy","s":"pages-113328816439","u":"c75b0ee3b63f","p":"page","rtyp":"page","rid":113328816439};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"04e927f0-5605-41ce-aeed-7b3baeb93b74"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"page","resourceType":"page","resourceId":113328816439,"requestId":"68d14ef9-d6b5-4853-b941-4e42f54c1fde-1787126638","shopifyEmitted":true});
...
<!-- END sections: header-group --><main id="site-content" class="site-content focus-none" role="main" tabindex="-1" data-site-content="">
  ...
  <div class="container container--extra-narrow" data-aos="fade-up"><h1 class="page-heading">
      ...
      img {
        ...
        <div class="rte">
      <p class="p1"><b>BRILLIANT LABS - CHÍNH SÁCH BẢO MẬT</b></p>
...
<p class="p1">Chúng tôi chỉ thu thập các thông tin cần thiết để cung cấp, duy trì, cải thiện Sản phẩm và Dịch vụ:</p>
<ul class="ul1">
<li class="li1"><b>Dữ liệu bạn cung cấp trực tiếp:</b> Họ tên, địa chỉ email, địa chỉ thanh toán/giao hàng, thông tin tài khoản, nội dung tin nhắn giao tiếp và các yêu cầu hỗ trợ.</li>
<li class="li1"><b>Dữ liệu phát sinh khi sử dụng:</b> Địa chỉ IP, loại thiết bị, hệ điều hành, nhật ký chẩn đoán, dữ liệu cảm biến (hướng nhìn, cử chỉ chạm trên gọng kính, cảm biến chuyển động 6 trục IMU).</li>
<li class="li1"><b>Dữ liệu Âm thanh, Hình ảnh và Môi trường:</b> Giọng nói, hình ảnh ghi nhận từ camera và micrô khi bạn kích hoạt tương tác với trợ lý AI Noa.</li>
<li class="li1"><b>Bộ nhớ AI (Narrative Memory):</b> Hệ thống AI Noa có thể tạo các bản tóm tắt ngữ cảnh từ tương tác trước đó để hỗ trợ bạn tốt hơn. Dữ liệu này được mã hóa, lưu trữ an toàn và bạn có toàn quyền xem hoặc xóa bất kỳ lúc nào trong ứng dụng.</li>
</ul>

<p class="p1"><b>3. Cách thức thu thập dữ liệu</b></p>
<p class="p1">Dữ liệu được thu thập thông qua: (1) Tương tác trực tiếp khi bạn tạo tài khoản, đặt hàng hoặc gửi liên hệ; (2) Thu thập trực tiếp từ thiết bị kính thông minh trong quá trình bạn sử dụng; (3) Ứng dụng di động trên iOS/Android; (4) Công nghệ tự động như cookie và nhật ký hệ thống nhằm đảm bảo an ninh mạng và tối ưu hóa hiệu năng.</p>

<p class="p1"><b>4. Cách chúng tôi sử dụng dữ liệu cá nhân của bạn</b></p>
<p class="p1">Chúng tôi sử dụng dữ liệu cá nhân trên các cơ sở pháp lý hợp lệ:</p>
<table cellspacing="0" cellpadding="0" class="t1" style="width: 100%; border-collapse: collapse; margin: 20px 0;">
<tbody>
<tr style="border-bottom: 1px solid #333;">
<th style="text-align: left; padding: 10px; color: #fff;">Mục đích / Hoạt động</th>
<th style="text-align: left; padding: 10px; color: #fff;">Loại dữ liệu</th>
<th style="text-align: left; padding: 10px; color: #fff;">Cơ sở pháp lý</th>
</tr>
<tr style="border-bottom: 1px solid #222;">
<td style="padding: 10px;">Đăng ký tài khoản và xác thực người dùng</td>
<td style="padding: 10px;">Danh tính, Liên hệ</td>
<td style="padding: 10px;">Thực hiện hợp đồng với bạn</td>
</tr>
<tr style="border-bottom: 1px solid #222;">
<td style="padding: 10px;">Xử lý đơn hàng, thanh toán và giao nhận thiết bị</td>
<td style="padding: 10px;">Danh tính, Liên hệ, Giao dịch tài chính</td>
<td style="padding: 10px;">Thực hiện hợp đồng</td>
</tr>
<tr style="border-bottom: 1px solid #222;">
<td style="padding: 10px;">Vận hành các tính năng tương tác AI thời gian thực, dịch thuật, nhận diện ngữ cảnh</td>
<td style="padding: 10px;">Âm thanh, Hình ảnh, Cảm biến, Kỹ thuật</td>
<td style="padding: 10px;">Thực hiện hợp đồng &amp; Lợi ích hợp pháp</td>
</tr>
<tr style="border-bottom: 1px solid #222;">
<td style="padding: 10px;">Đảm bảo an toàn hệ thống, phòng chống gian lận và sự cố bảo mật</td>
<td style="padding: 10px;">Kỹ thuật, Nhật ký truy cập</td>
<td style="padding: 10px;">Nghĩa vụ pháp lý &amp; Lợi ích hợp pháp</td>
</tr>
</tbody>
</table>

<p class="p1"><b>Xử lý trên thiết bị (On-Device) vs Đám mây (Cloud):</b> Brilliant ưu tiên xử lý dữ liệu trực tiếp trên thiết bị (On-Device Neural Processor) nhằm bảo vệ quyền riêng tư tối đa. Chỉ những tác vụ đòi hỏi tài nguyên tính toán lớn mới được truyền mã hóa tạm thời lên máy chủ đám mây và dữ liệu thô sẽ bị xóa ngay sau khi hoàn thành phản hồi.</p>

<p class="p1"><b>5. Tiết lộ dữ liệu cá nhân</b></p>
<p class="p1">Brilliant không bán dữ liệu cá nhân của người dùng. Chúng tôi chỉ chia sẻ dữ liệu trong các trường hợp cần thiết với:</p>
<ul class="ul1">
<li class="li1">Nhà cung cấp dịch vụ hạ tầng đám mây và thanh toán (ví dụ: Amazon Web Services, cổng thanh toán bảo mật).</li>
<li class="li1">Nhà cung cấp mô hình AI bên thứ ba (như OpenAI, Anthropic, Whisper) – các đơn vị này bị ràng buộc hợp đồng nghiêm ngặt, cấm sử dụng dữ liệu người dùng cho mục đích đào tạo mô hình riêng.</li>
<li class="li1">Cơ quan quản lý nhà nước khi có yêu cầu bắt buộc theo quy định của pháp luật.</li>
</ul>

<p class="p1"><b>6. Chuyển giao dữ liệu quốc tế</b></p>
<p class="p1">Chúng tôi hoạt động trên toàn cầu và có thể chuyển dữ liệu đến các máy chủ an toàn tại Singapore, Hoa Kỳ hoặc Khu vực Kinh tế Châu Âu (EEA). Mọi hoạt động chuyển giao đều áp dụng các biện pháp bảo vệ pháp lý nghiêm ngặt như Điều khoản Hợp đồng Tiêu chuẩn (SCC) của Ủy ban Châu Âu và tuân thủ PDPA Singapore.</p>

<p class="p1"><b>7. Bảo mật dữ liệu</b></p>
<p class="p1">Chúng tôi áp dụng các tiêu chuẩn bảo mật kỹ thuật và tổ chức cao nhất: mã hóa toàn diện dữ liệu khi truyền tải (in-transit) và khi lưu trữ (at-rest), phân quyền truy cập nghiêm ngặt, sao lưu định kỳ và quy trình ứng phó sự cố an ninh thông tin 24/7.</p>

<p class="p1"><b>8. Lưu trữ dữ liệu</b></p>
<p class="p1">Dữ liệu cá nhân chỉ được lưu trữ trong khoảng thời gian cần thiết để phục vụ các mục đích được nêu trong chính sách này hoặc theo quy định của pháp luật về thuế và kế toán. Khi bạn yêu cầu xóa tài khoản, toàn bộ dữ liệu bộ nhớ AI và thông tin cá nhân sẽ được xóa vĩnh viễn trong vòng 30 ngày.</p>

<p class="p1"><b>9. Quyền pháp lý của bạn</b></p>
<p class="p1">Bạn có đầy đủ các quyền theo quy định của pháp luật:</p>
<ul class="ul1">
<li class="li1"><b>Quyền truy cập:</b> Yêu cầu cung cấp bản sao dữ liệu cá nhân chúng tôi đang nắm giữ.</li>
...
<p class="p1">Người dùng tại EEA, Vương quốc Anh, California và Singapore được hưởng đầy đủ các quyền bổ sung đặc thù theo quy định của GDPR, CCPA/CPRA và PDPA (bao gồm quyền chuyển đổi dữ liệu Data Portability, không bị phân biệt đối xử khi thực hiện quyền riêng tư và quyền khiếu nại tới Cơ quan Bảo vệ Dữ liệu có thẩm quyền).</p>

<p class="p1"><b>11. Thỏa thuận Xử lý Dữ liệu (DPA) cho Doanh nghiệp &amp; Nhà phát triển</b></p>
