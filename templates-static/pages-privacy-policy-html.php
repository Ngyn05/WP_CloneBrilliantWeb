...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
...
<!-- END sections: header-group --><main id="site-content" class="site-content focus-none" role="main" tabindex="-1" data-site-content="">
  ...
  <div class="container container--extra-narrow" data-aos="fade-up">
    <?php 
      $page_obj = get_page_by_path( 'privacy-policy', OBJECT, 'page' );
      $page_title   = $page_obj ? $page_obj->post_title : 'Chính sách bảo mật';
