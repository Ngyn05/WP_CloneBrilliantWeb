<?php
/** Static interface converted from blogs/announcements-2.html */
...
<meta property="og:url" content="https://brilliant.xyz/blogs/announcements">
...
<link rel="next" href="<?php echo esc_url( home_url( '/blogs/announcements-1/?page=2' ) ); ?>">
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"22d1f1c8-5770-4054-ac14-a79db20a9232-1787130234","pageurl":"brilliant.xyz\/blogs\/announcements?page=1","s":"blogs-113034559799","u":"1accf372f326","p":"blog","rtyp":"blog","rid":113034559799};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"624e8ab7-2678-48ef-ba0e-c9d39bef9bf6"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"blog","resourceType":"blog","resourceId":113034559799,"requestId":"22d1f1c8-5770-4054-ac14-a79db20a9232-1787130234","shopifyEmitted":true});
...
<!-- END sections: header-group --><main id="site-content" class="site-content focus-none" role="main" tabindex="-1" data-site-content="">
      <div id="shopify-section-template--24820771684663__main" class="shopify-section"><link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/section-main-blog.css?v=97860431182083279661752050583' ); ?>" rel="stylesheet" type="text/css" media="all">
<link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-article-card.css?v=138369773923246243871752050579' ); ?>" rel="stylesheet" type="text/css" media="all">
<div class="blog blog--template--24820771684663__main main-section">
  <div class="container" data-aos="fade-up">
    <div class="blog__header">
      <h1 class="page-heading">
        Thông báo
      </h1><div class="blog__filters">
          <a class="button " href="<?php echo esc_url( home_url( '/blogs/announcements/' ) ); ?>" title="Mới nhất">
            Mới nhất
          </a><a class="button button--secondary" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/brilliant-labs-team/' ) ); ?>" title="Đội ngũ Brilliant Labs">
              Đội ngũ Brilliant Labs
            </a><a class="button button--secondary" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/cộng đồng/' ) ); ?>" title="Cộng đồng">
              Cộng đồng
            </a><a class="button button--secondary" href="<?php echo esc_url( home_url( '/blogs/announcements/tagged/industry-updates/' ) ); ?>" title="Cập nhật ngành">
              Cập nhật ngành
            </a></div></div><div class="row"><div class="col-12"><div class="article-card article-card--grid ">
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-6/' ) ); ?>" title="Hành trình đến Halo | Phần 6">
    <div class="row row--align-center"><div class="col-12 col-md-6">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-6.gif?v=1760154505' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-1.gif' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-2.gif' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-3.gif' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-4.gif' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-5.gif' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/breakdown_2c66ec25-5764-4999-99e3-c0b9ad7b8714-6.gif' ); ?> 1080w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="1280" height="720"></div>
        </div><div class="article-card__content col-12 col-md-6 text-left"><p class="article-card__title h4 d-md-none">Hành trình đến Halo | Phần 6
</p><p class="article-card__title h2 d-none d-md-block">Hành trình đến Halo | Phần 6
</p><p class="article-card__excerpt">
            Điều này sẽ thay đổi mọi thứ.
📺💾📼📸📟📀🎮🖥️💻📱⌚️… 😎

Đây là những ngày đầu tiên của bước chuyển biến lớn trong điện toán: từ trải nghiệm thiết bị phản ứng bị động sang chủ động...
          </p><p>10/11/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-5/' ) ); ?>" title="Hành trình đến Halo | Phần 5">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-5.gif?v=1760154522' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-1.gif' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-2.gif' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-3.gif' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-4.gif' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Falo_Shines_479cc62e-a8b5-4946-a612-0766aa223828-5.gif' ); ?> 720w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="720" height="486"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hành trình đến Halo | Phần 5
</p><p class="article-card__excerpt">
            🧠 Bộ nhớ thực sự quan trọng

“Tôi không nhớ tên anh ấy là gì.”
“Chúng ta đã nói về chuyện gì nhỉ?”
“Lần cuối tôi gặp anh ấy là ở đâu?”
“Tôi là ai?”...
          </p><p>10/11/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-4/' ) ); ?>" title="Hành trình đến Halo | Phần 4">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-7.webp?v=1760152981' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-3.webp' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-4.webp' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-5.webp' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-6.webp' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_2978_1-7.webp' ); ?> 1296w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="1363" height="1022"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hành trình đến Halo | Phần 4
</p><p class="article-card__excerpt">
            Hành trình đến Halo | Phần 4
💪🏼 Halo phá bỏ sự đánh đổi sai lầm giữa quyền riêng tư và mã nguồn mở. Kỷ nguyên điện toán tiếp theo phải tôn trọng bạn...
          </p><p>10/11/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
            </span>
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-3-of-4/' ) ); ?>" title="Hành trình đến Halo | Phần 3">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7142_3ca8e4c3-66bc-4262-a193-f9213bc38c2e.webp?v=1756165881' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7142_3ca8e4c3-66bc-4262-a193-f9213bc38c2e-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7142_3ca8e4c3-66bc-4262-a193-f9213bc38c2e-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7142_3ca8e4c3-66bc-4262-a193-f9213bc38c2e-3.webp' ); ?> 360w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="523" height="697"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hành trình đến Halo | Phần 3
</p><p class="article-card__excerpt">
            🎨 Quá trình nghiên cứu phần cứng Halo đòi hỏi sự định hướng rõ ràng, chắt lọc tinh tế, mục tiêu mạch lạc và thiết kế tỉ mỉ ở mọi tầng công nghệ...
          </p><p>08/26/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
            </span>
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-2-of-4/' ) ); ?>" title="Hành trình đến Halo | Phần 2">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016.jpg?v=1755644717' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-1.jpg' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-2.jpg' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-3.jpg' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-4.jpg' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-5.jpg' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-6.jpg' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-7.jpg' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-8.jpg' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-9.jpg' ); ?> 1728w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-10.jpg' ); ?> 1944w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-11.jpg' ); ?> 2160w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="2316" height="3088"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hành trình đến Halo | Phần 2
</p><p class="article-card__excerpt">
            Noa dành cho Halo đã có một bước tiến vượt bậc! 🥳🛠 Chúng tôi có tầm nhìn rõ ràng về trải nghiệm phần mềm lý tưởng cùng đàm thoại đa phương thức...
          </p><p>08/20/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
            </span>
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-1-of-4/' ) ); ?>" title="Hành trình đến Halo | Phần 1">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_1838_e8390610-7d22-4ae7-9456-8d14b7cb4aae-4.webp?v=1755118764' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_1838_e8390610-7d22-4ae7-9456-8d14b7cb4aae-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_1838_e8390610-7d22-4ae7-9456-8d14b7cb4aae-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_1838_e8390610-7d22-4ae7-9456-8d14b7cb4aae-3.webp' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_1838_e8390610-7d22-4ae7-9456-8d14b7cb4aae-4.webp' ); ?> 540w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hành trình đến Halo " loading="lazy" width="594" height="792"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Hành trình đến Halo | Phần 1
</p><p class="article-card__excerpt">
            Sự đón nhận dành cho Halo thật vô cùng to lớn ❤️ Và bây giờ, hãy cùng khám phá câu chuyện phía sau hành trình phát triển...
          </p><p>08/13/2025
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
            </span>
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/citizenones-frame-projects/' ) ); ?>" title="CitizenOne&#39;s Frame Projects">
    <div class="row row--align-center"><div class="col-12 ">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp?v=1732103247' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-3.webp' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-4.webp' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp' ); ?> 720w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="CitizenOne&#39;s Frame Projects" loading="lazy" width="928" height="751"></div>
        </div><div class="article-card__content col-12  text-left"><p class="article-card__title h4">Các dự án Frame của CitizenOne 🕹️
</p><p class="article-card__excerpt">
            Demo ghim vị trí AR trực tiếp: Hiển thị các ghim điều hướng và địa điểm yêu thích (POI) ngay trong tầm nhìn cùng cảm biến của Frame...
          </p><p>11/21/2024
&nbsp;&mdash;&nbsp;<span class="underlined-link">
              Đọc bài viết
            </span>
...
</div></div></div><link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-pagination.css?v=36509695587630536881752050579' ); ?>" rel="stylesheet" type="text/css" media="all">
<div class="pagination-wrapper">
    <nav class="pagination" role="navigation" aria-label="Pagination">
      <ul class="pagination__list" role="list"><li><a class="pagination__item pagination__item--current" role="link" aria-disabled="true" aria-current="page" aria-label="Page 1">
                1
              </a></li><li><a class="pagination__item color-foreground" href="<?php echo esc_url( home_url( '/blogs/announcements-1/?page=2' ) ); ?>" aria-label="Page 2">
              2
            </a></li><li>
          <a class="pagination__item pagination__item--next pagination__item--no-hover" href="<?php echo esc_url( home_url( '/blogs/announcements-1/?page=2' ) ); ?>" aria-label="Next page"><svg class="icon icon-arrow-right-small" aria-hidden="true" focusable="false" role="presentation" width="14" height="11" viewbox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12.7071 5.0455L8.36247 0.602685M12.7071 5.0455L8.40454 9.60538M12.7071 5.0455L0.707093 5.1138" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
</svg></a>
        </li></ul>
    </nav>
  </div></div>
</div><style data-shopify="">.blog--template--24820771684663__main {
    margin-top: 0px;
    margin-bottom: 0px;
    padding-top: 32px;
    padding-bottom: 32px;
  ...
  @media screen and (min-width: 768px) {
    .blog--template--24820771684663__main {
      margin-top: 0px;
      margin-bottom: 0px;
      padding-top: 36px;
      padding-bottom: 36px;
...
</div><div id="shopify-section-template--24820771684663__featured_videos_3FX6bm" class="shopify-section"><script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/section-featured-videos.js?v=166030343122462640341752050580' ); ?>" defer="defer"></script>
...
<featured-videos class="featured-videos featured-videos--desktop-carousel featured-videos--template--24820771684663__featured_videos_3FX6bm color-scheme--default no-js-hidden" data-featured-videos="">
  <div class="container container--narrow" data-aos="fade-up"><div class="section-heading section-heading--large section-heading--left"><div class="row row--align-center">
        <div class="col-md-6">
          <h2 class=" text-left">
  ...
  <button class="video__button" type="button" aria-label="Load video: I have tested my fair share of smart glasses, and they all have one thing in common -- they are bulky. That changes with Frame by Brilliant Labs, a lightweight and sleek pair of smart glasses with a single microOLED screen that displays heads-up information, and a tiny camera that can do visual analysis of the real-world. The glasses run multiple AI models such as ChatGPT, Perplexity and Whisper." data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc.jpg?v=1729500422' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc.jpg' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-1.jpg' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-2.jpg' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-3.jpg' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-4.jpg' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-5.jpg' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-6.jpg' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-7.jpg' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-8.jpg' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-9.jpg' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1912" height="1021" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/hBbrrNylidY" allow="autoplay; encrypted-media" allowfullscreen="" title="I have tested my fair share of smart glasses, and they all have one thing in common -- they are bulky. That changes with Frame by Brilliant Labs, a lightweight and sleek pair of smart glasses with a single microOLED screen that displays heads-up information, and a tiny camera that can do visual analysis of the real-world. The glasses run multiple AI models such as ChatGPT, Perplexity and Whisper."></iframe></div><p class="video__title h4">
      Kính thông minh Frame AI: Bước tiến tiếp theo trong điện toán cá nhân
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44.png?v=1728609773' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-5.png' ); ?> 720w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="976" height="419" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/GNlywpRvP_Q" allow="autoplay; encrypted-media" allowfullscreen="" title="Video description"></iframe></div><p class="video__title h4">
      Kính thông minh nhỏ gọn nhất có thể làm được những gì?
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
  ...
  <button class="video__button" type="button" aria-label="Load video: I might look like Harry Potter with these, but maybe I might get some crazy wizardy powers out of these, because what hides in these glasses is the framework to use and create with the Ai on ease, with features like Live translation, from speech and text, Visual recognition, image generation and web search ( of course powered by Ai )" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21.png?v=1728475038' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-9.png' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1914" height="1026" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/dS-SyiU3lTE" allow="autoplay; encrypted-media" allowfullscreen="" title="I might look like Harry Potter with these, but maybe I might get some crazy wizardy powers out of these, because what hides in these glasses is the framework to use and create with the Ai on ease, with features like Live translation, from speech and text, Visual recognition, image generation and web search ( of course powered by Ai )"></iframe></div><p class="video__title h4">
      Kính thông minh AI nhẹ nhất với màn hình MICRO-OLED! Brilliant Labs Frame
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48.png?v=1728610375' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-5.png' ); ?> 720w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="875" height="431" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/t7mDknFTCPk" allow="autoplay; encrypted-media" allowfullscreen="" title="Video description"></iframe></div><p class="video__title h4">
      100 ngày trải nghiệm cuộc sống cùng AI!
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
  ...
  <button class="video__button" type="button" aria-label="Load video: Video description" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22.png?v=1728610050' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-8.png' ); ?> 1512w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1642" height="871" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/iNFG6FIDCKQ" allow="autoplay; encrypted-media" allowfullscreen="" title="Video description"></iframe></div><p class="video__title h4">
      Cặp kính AI đầu tiên của tôi! - Brilliant Labs Frame
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
  ...
  <button class="video__button" type="button" aria-label="Load video: In this video, we explore Brilliant Labs&amp;#39; latest updates for their groundbreaking Frame AI smart glasses. With enhanced features like advanced text-to-speech, a new graphics and vector engine, and seamless integration with your favorite AI models like GPT-4, these glasses are pushing the boundaries of wearable tech. Learn how these innovations make AI more accessible and interactive in everyday life. Don&amp;#39;t miss out on the future of smart glasses technology!" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52.png?v=1728474765' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-9.png' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1920" height="1024" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/_9VUPq3SxOc" allow="autoplay; encrypted-media" allowfullscreen="" title="In this video, we explore Brilliant Labs&#39; latest updates for their groundbreaking Frame AI smart glasses. With enhanced features like advanced text-to-speech, a new graphics and vector engine, and seamless integration with your favorite AI models like GPT-4, these glasses are pushing the boundaries of wearable tech. Learn how these innovations make AI more accessible and interactive in everyday life. Don&#39;t miss out on the future of smart glasses technology!"></iframe></div><p class="video__title h4">
      Cách mạng hóa công nghệ đeo: Kính Frame của Brilliant Labs
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
</strong>
</component-video></div><div class="d-none" data-index="7" data-featured-video=""><component-video class="video ">
  <button class="video__button" type="button" aria-label="Load video: I LOVE smart glasses, but they&amp;#39;re often heavy. The folks at Brilliant Labs have a fresh take on a simple Heads Up Màn hình, and it&amp;#39;s the lightest headset I&amp;#39;ve ever worn. A tool for developers, FRAME is the most interesting hardware I&amp;#39;ve seen for AI. Machine learning is a lot more fun when you go hands free..." data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33.png?v=1728474920' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-9.png' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1916" height="1027" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/IeAvxDJ9P30" allow="autoplay; encrypted-media" allowfullscreen="" title="I LOVE smart glasses, but they&#39;re often heavy. The folks at Brilliant Labs have a fresh take on a simple Heads Up Màn hình, and it&#39;s the lightest headset I&#39;ve ever worn. A tool for developers, FRAME is the most interesting hardware I&#39;ve seen for AI. Machine learning is a lot more fun when you go hands free..."></iframe></div><p class="video__title h4">
      Frame từ Brilliant Labs: Kính thông minh là cách tốt nhất để sử dụng AI!
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;3:21
</strong>
</component-video></div></div><div class="col-12 "><div class="featured-videos__carousel   d-md-flex">
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: I have tested my fair share of smart glasses, and they all have one thing in common -- they are bulky. That changes with Frame by Brilliant Labs, a lightweight and sleek pair of smart glasses with a single microOLED screen that displays heads-up information, and a tiny camera that can do visual analysis of the real-world. The glasses run multiple AI models such as ChatGPT, Perplexity and Whisper." data-index="1" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc.jpg?v=1729500422' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc.jpg' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-1.jpg' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-2.jpg' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-3.jpg' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-4.jpg' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-5.jpg' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-6.jpg' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-7.jpg' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-8.jpg' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.50.04_521f06c4-b990-4a94-b733-f236bfae26bc-9.jpg' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1912" height="1021" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Kính thông minh Frame AI: Bước tiến tiếp theo trong điện toán cá nhân
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="2" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44.png?v=1728609773' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.22.44-5.png' ); ?> 720w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="976" height="419" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Kính thông minh nhỏ gọn nhất có thể làm được những gì?
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: I might look like Harry Potter with these, but maybe I might get some crazy wizardy powers out of these, because what hides in these glasses is the framework to use and create with the Ai on ease, with features like Live translation, from speech and text, Visual recognition, image generation and web search ( of course powered by Ai )" data-index="3" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21.png?v=1728475038' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.56.21-9.png' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1914" height="1026" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Kính thông minh AI nhẹ nhất với màn hình MICRO-OLED! Brilliant Labs Frame
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="4" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48.png?v=1728610375' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.32.48-5.png' ); ?> 720w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="875" height="431" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        100 ngày trải nghiệm cuộc sống cùng AI!
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Video description" data-index="5" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22.png?v=1728610050' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-11_at_09.27.22-8.png' ); ?> 1512w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1642" height="871" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Cặp kính AI đầu tiên của tôi! - Brilliant Labs Frame
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: In this video, we explore Brilliant Labs&amp;#39; latest updates for their groundbreaking Frame AI smart glasses. With enhanced features like advanced text-to-speech, a new graphics and vector engine, and seamless integration with your favorite AI models like GPT-4, these glasses are pushing the boundaries of wearable tech. Learn how these innovations make AI more accessible and interactive in everyday life. Don&amp;#39;t miss out on the future of smart glasses technology!" data-index="6" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52.png?v=1728474765' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.51.52-9.png' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1920" height="1024" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Cách mạng hóa công nghệ đeo: Kính Frame của Brilliant Labs
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: I LOVE smart glasses, but they&amp;#39;re often heavy. The folks at Brilliant Labs have a fresh take on a simple Heads Up Màn hình, and it&amp;#39;s the lightest headset I&amp;#39;ve ever worn. A tool for developers, FRAME is the most interesting hardware I&amp;#39;ve seen for AI. Machine learning is a lot more fun when you go hands free..." data-index="7" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33.png?v=1728474920' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.53.33-9.png' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1916" height="1027" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Frame từ Brilliant Labs: Kính thông minh là cách tốt nhất để sử dụng AI!
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
...
</featured-videos><style data-shopify="">.featured-videos--template--24820771684663__featured_videos_3FX6bm {
    margin-top: 0px;
    margin-bottom: 0px;
    padding-top: 32px;
    padding-bottom: 32px;
  ...
  @media screen and (min-width: 768px) {
    .featured-videos--template--24820771684663__featured_videos_3FX6bm {
      margin-top: 0px;
      margin-bottom: 0px;
      padding-top: 72px;
      padding-bottom: 72px;
  ...
  }</style></div><div id="shopify-section-template--24820771684663__featured_videos_6y8HYX" class="shopify-section"><script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/section-featured-videos.js?v=166030343122462640341752050580' ); ?>" defer="defer"></script>
<script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-video.js?v=49218978051593286841752050580' ); ?>" defer="defer"></script>
<link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/section-featured-videos.css?v=155562086629565823551752050580' ); ?>" rel="stylesheet" type="text/css" media="all">
<link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-video.css?v=143258516030285971091752050583' ); ?>" rel="stylesheet" type="text/css" media="all">
<link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-featured-video-card.css?v=106538093764685120111752050580' ); ?>" rel="stylesheet" type="text/css" media="all">
<featured-videos class="featured-videos featured-videos--desktop-carousel featured-videos--template--24820771684663__featured_videos_6y8HYX color-scheme--default no-js-hidden" data-featured-videos="">
  <div class="container container--narrow" data-aos="fade-up"><div class="section-heading section-heading--large section-heading--left"><div class="row row--align-center">
        <div class="col-md-6">
          <h2 class=" text-left">
            Sự kiện
      ...
      <div class="col-12 "><div class="" data-index="1" data-featured-video=""><component-video class="video ">
  <button class="video__button" type="button" aria-label="Load video: August 3rd Hackathon overview" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48.png?v=1728472211' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-9.png' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1840" height="988" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/K5Ob_5lUDPo" allow="autoplay; encrypted-media" allowfullscreen="" title="August 3rd Hackathon overview"></iframe></div><p class="video__title h4">
      Tổng quan Hackathon
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
  ...
  <button class="video__button" type="button" aria-label="Load video: Bobak of Brilliant Labs and Dennis of Niantic introduce the Frame Hackathon Aug 3rd 2024" data-video-play-button="">
    <div class="video__image-wrapper "><img class="video__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01.png?v=1728473834' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-9.png' ); ?> 1728w" sizes="(min-width: 1025px) 1400px" alt="" loading="lazy" width="1917" height="1026" style="object-position: 50.0% 50.0%;"></div>
  ...
  <div class="video__wrapper responsive-video d-none" data-video-wrapper=""><iframe data-src="https://www.youtube.com/embed/CqLb98vIm38" allow="autoplay; encrypted-media" allowfullscreen="" title="Bobak of Brilliant Labs and Dennis of Niantic introduce the Frame Hackathon Aug 3rd 2024"></iframe></div><p class="video__title h4">
      Giới thiệu Hackathon
    </p><strong class="video__meta"><svg class="icon icon-youtube" aria-hidden="true" focusable="false" role="presentation" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1491 4.24629C29.5217 4.4771 31.2164 5.07011 31.7194 9.37256C32.0941 12.5779 32.0929 18.0297 31.7194 21.2239C31.2164 25.5263 29.5217 26.1193 26.1491 26.3503C21.3541 26.6785 10.6492 26.6787 5.85085 26.3503C2.47835 26.1193 0.78367 25.5263 0.280602 21.2239C-0.0941551 18.0186 -0.0929124 12.5668 0.280602 9.37256C0.783592 5.07019 2.47835 4.47718 5.85085 4.24629C10.6492 3.91778 21.3541 3.91802 26.1491 4.24629ZM12.8138 10.8118V19.7943L21.3736 15.3031L12.8138 10.8118Z" fill="#FF0000"></path>
</svg>YouTube
        &nbsp;&mdash;&nbsp;7:18
  ...
  <path d="M8.51941 5.3262L15.4762 11.958C15.482 11.9635 15.482 11.9728 15.4764 11.9784L8.58504 18.6738" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
              ...
              <div class="swiper" data-swiper="">
                <div class="swiper-wrapper"><div class="swiper-slide"><div class="featured-video-card">
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: August 3rd Hackathon overview" data-index="1" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48.png?v=1728472211' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.09.48-9.png' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1840" height="988" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Tổng quan Hackathon
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
  ...
  <button class="featured-video-card__button hover-effect--zoom" type="button" aria-label="Load video: Bobak of Brilliant Labs and Dennis of Niantic introduce the Frame Hackathon Aug 3rd 2024" data-index="2" data-featured-video-card-play-button="">
    <div class="featured-video-card__image-wrapper "><img class="featured-video-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01.png?v=1728473834' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01.png' ); ?> 50w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-1.png' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-2.png' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-3.png' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-4.png' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-5.png' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-6.png' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-7.png' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-8.png' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/Screenshot_2024-10-09_at_19.37.01-9.png' ); ?> 1728w" sizes="(max-width: 767px) 100vw, 400px" alt="" loading="lazy" width="1917" height="1026" style="object-position: 50.0% 50.0%;"></div><p class="featured-video-card__title font-heading">
        Giới thiệu Hackathon
      </p><span class="featured-video-card__meta p--bold"><svg class="icon icon-play" aria-hidden="true" focusable="false" role="presentation" width="120" height="120" viewbox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M59.8833 0H59.883C26.8105 0 0 26.8105 0 59.883V59.8833C0 92.9558 26.8105 119.766 59.883 119.766H59.8833C92.9558 119.766 119.766 92.9558 119.766 59.8833V59.883C119.766 26.8105 92.9558 0 59.8833 0Z" fill="white"></path>
  <path d="M44.9123 39.922V79.8442L79.8442 59.8831L44.9123 39.922Z" fill="black"></path>
...
</featured-videos><style data-shopify="">.featured-videos--template--24820771684663__featured_videos_6y8HYX {
    margin-top: 0px;
    margin-bottom: 0px;
    padding-top: 32px;
    padding-bottom: 32px;
  ...
  @media screen and (min-width: 768px) {
    .featured-videos--template--24820771684663__featured_videos_6y8HYX {
      margin-top: 0px;
      margin-bottom: 0px;
      padding-top: 72px;
      padding-bottom: 72px;
