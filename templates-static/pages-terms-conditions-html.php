<?php
/** Static interface converted from pages/terms-conditions.html */
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"9aa3bc37-910b-48f7-8875-1fdf104c9034-1787126637","pageurl":"brilliant.xyz\/pages\/terms-conditions","s":"pages-113328849207","u":"7ae2325dec2c","p":"page","rtyp":"page","rid":113328849207};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"31b32192-fa3b-4d54-81c9-ce63f6860302"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"page","resourceType":"page","resourceId":113328849207,"requestId":"9aa3bc37-910b-48f7-8875-1fdf104c9034-1787126637","shopifyEmitted":true});
...
<script defer="" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shopifycloud/perf-kit/shopify-perf-kit-3.8.3.min.js' ); ?>" data-application="storefront-renderer" data-shop-id="72251900215" data-render-region="gcp-asia-southeast1" data-page-type="page" data-theme-instance-id="179256688951" data-theme-name="Creator" data-theme-version="3.2.2" data-monorail-region="shop_domain" data-resource-timing-sampling-rate="10" data-shs="true" data-shs-beacon="true" data-shs-export-with-fetch="true" data-shs-logs-sample-rate="1" data-shs-beacon-endpoint="https://brilliant.xyz/api/collect"></script>
...
<p class="p2">Brilliant Labs Pte. Ltd. (UEN: 202316146G), một công ty được thành lập theo luật pháp Singapore (“<b>Brilliant</b>,” “<b>Công ty</b>,” “<b>chúng tôi</b>”), cung cấp các sản phẩm, dịch vụ và nội dung liên quan thông qua các thiết bị kính thông minh AI (bao gồm Halo, Frame, Monocle và các phiên bản tiếp theo), tác nhân AI tích hợp và các dịch vụ nền tảng (bao gồm Noa và các dịch vụ tiếp theo), ứng dụng di động trên các kho ứng dụng, phụ kiện và công nghệ liên quan, cũng như qua trang web chính thức tại https://brilliant.xyz/ và các trang web khác do Brilliant vận hành.</p>
<p class="p2">Việc truy cập và sử dụng Sản phẩm và Dịch vụ phải tuân thủ các Điều khoản Dịch vụ này (“<b>Điều khoản</b>”). Bằng việc truy cập, duyệt hoặc sử dụng bất kỳ Sản phẩm hoặc Dịch vụ nào của Brilliant, bạn xác nhận rằng bạn đã đọc, hiểu và đồng ý tuân thủ các Điều khoản này và Chính sách Bảo mật. Nếu bạn không đồng ý, bạn không được phép sử dụng Sản phẩm hoặc Dịch vụ.</p>
<p class="p2"><b>Định nghĩa</b></p>
<p class="p2">Đối với các mục đích của Điều khoản này:</p>
<p class="p2">“<b>Sản phẩm</b>” có nghĩa là các thiết bị kính thông minh AI của Brilliant (bao gồm Halo, Frame, Monocle và các thế hệ kế tiếp), tác nhân AI tích hợp và dịch vụ nền tảng (bao gồm Noa), ứng dụng di động phân phối qua kho ứng dụng (App Store, Google Play), phụ kiện, phần cứng và toàn bộ tính năng, bản cập nhật liên quan.</p>
<p class="p2">“<b>Dịch vụ</b>” có nghĩa là: (i) việc bạn sử dụng hoặc truy cập vào Sản phẩm; (ii) việc bạn sử dụng hoặc truy cập trang web https://brilliant.xyz/ và các tên miền phụ; (iii) tất cả giao diện, đồ họa, thiết kế, mã máy tính, phần mềm, dịch vụ mà Brilliant cung cấp; (iv) tất cả nội dung hình ảnh, âm thanh, tương tác; (v) các công nghệ, mạng lưới và hệ thống vận hành liên quan; và (vi) các bản nâng cấp, sửa đổi, bổ sung mà Brilliant cung cấp.</p>
<p class="p2">“<b>Khách hàng Doanh nghiệp</b>” có nghĩa là Người dùng truy cập hoặc sử dụng Sản phẩm và Dịch vụ cho các mục đích kinh doanh thương mại theo hợp đồng văn bản riêng biệt với Công ty.</p>
<p class="p2"><b>Chính sách Bảo mật</b></p>
<p class="p2">Vui lòng xem lại Chính sách Bảo mật của chúng tôi (tại https://brilliant.xyz/pages/privacy-policy) để biết thông tin về cách chúng tôi thu thập, sử dụng và bảo vệ dữ liệu cá nhân. Bằng cách sử dụng bất kỳ Sản phẩm hoặc Dịch vụ nào, bạn đồng ý với các phương thức xử lý dữ liệu được mô tả trong Chính sách Bảo mật.</p>
<p class="p2"><b>VUI LÒNG ĐỌC KỸ CÁC ĐIỀU KHOẢN NÀY</b>. Nếu bạn không đồng ý với bất kỳ điều khoản nào, bạn nên ngừng sử dụng Sản phẩm và Dịch vụ ngay lập tức. Chúng tôi có quyền sửa đổi hoặc cập nhật các phần của Điều khoản Dịch vụ và Chính sách Bảo mật theo quyết định của mình và sẽ cập nhật ngày sửa đổi ở đầu trang.</p>
<p class="p2"><b>Thông báo Quan trọng – Trọng tài và Giải quyết Tranh chấp</b></p>
<p class="p2">ĐIỀU KHOẢN NÀY CHỨA THỎA THUẬN TRỌNG TÀI VÀ CÁC QUY ĐỊNH QUAN TRỌNG VỀ QUYỀN PHÁP LÝ CỦA BẠN. BẰNG VIỆC CHẤP NHẬN ĐIỀU KHOẢN NÀY, BẠN:</p>
<ol class="ol1">
<li class="li2">ĐỒNG Ý GIẢI QUYẾT MỌI TRANH CHẤP VỚI BRILLIANT THÔNG QUA TRỌNG TÀI RÀNG BUỘC (SIAC SINGAPORE), TRỪ KHI PHÁP LUẬT CÓ QUY ĐỊNH KHÁC.</li>
<li class="li2">TỪ BỎ QUYỀN THAM GIA VÀO CÁC VỤ KIỆN TẬP THỂ HOẶC ĐẠI DIỆN TẬP THỂ.</li>
<li class="li2">HIỂU RẰNG CÁC TRANH CHẤP SẼ ĐƯỢC GIẢI QUYẾT BỞI TRỌNG TÀI VIÊN DUY NHẤT THAY VÌ TÒA ÁN HOẶC BỒI THẨM ĐOÀN.</li>
</ol>
<p class="p2">VUI LÒNG XEM MỤC 8 (LUẬT ĐIỀU CHỈNH VÀ TRỌNG TÀI) ĐỂ BIẾT CHI TIẾT ĐẦY ĐỦ.</p>
<p class="p4"><b>1. SỬ DỤNG SẢN PHẨM VÀ DỊCH VỤ</b></p>
<p class="p2"><b>1.1 QUYỀN SỬ DỤNG SẢN PHẨM VÀ DỊCH VỤ</b></p>
<p class="p2">Công ty cấp cho bạn quyền và giấy phép có giới hạn, không độc quyền, có thể thu hồi, miễn phí bản quyền, không thể chuyển nhượng, không thể cấp phép lại để truy cập và sử dụng Sản phẩm, Dịch vụ và Nội dung liên quan cho mục đích sử dụng cá nhân phù hợp với Điều khoản này (gọi là “<b>Giấy phép Có giới hạn</b>”).</p>
<p class="p2">Giấy phép này không bao gồm việc bán lại Sản phẩm hoặc Dịch vụ (trừ khi được Công ty cho phép bằng văn bản). Tất cả quyền sở hữu trí tuệ, giao diện, phần mềm, thiết kế, thương hiệu thuộc quyền sở hữu duy nhất và độc quyền của Brilliant Labs hoặc các bên cấp phép liên quan.</p>
<p class="p2"><b>1.2 ĐIỀU KIỆN SỬ DỤNG</b></p>
<p class="p2">Bạn phải từ đủ 18 tuổi trở lên để sử dụng Sản phẩm và Dịch vụ. Bằng việc đồng ý với Điều khoản này, bạn cam kết rằng bạn có đầy đủ năng lực pháp lý để ký kết hợp đồng ràng buộc và việc sử dụng của bạn tuân thủ mọi luật pháp hiện hành.</p>
<p class="p2"><b>1.3 TÀI KHOẢN VÀ ĐĂNG KÝ</b></p>
<p class="p2">Bạn có thể tạo tài khoản Brilliant để sử dụng Sản phẩm và Dịch vụ. Bạn chịu trách nhiệm hoàn toàn về việc bảo mật thông tin tài khoản, mật khẩu và mọi hoạt động diễn ra dưới tài khoản của mình. Nếu phát hiện tài khoản bị xâm phạm, hãy thông báo ngay cho chúng tôi qua email hello@brilliant.xyz.</p>
<p class="p2"><b>1.4 CÁC HÀNH VI BỊ NGHIÊM CẤM</b></p>
<p class="p2">Bạn cam kết chỉ sử dụng Sản phẩm và Dịch vụ cho các mục đích hợp pháp và KHÔNG thực hiện các hành vi sau:</p>
<ul class="ul1">
<li class="li2">Sử dụng thiết bị khi đang lái xe, vận hành máy móc hạng nặng hoặc thực hiện các công việc đòi hỏi sự chú ý tập trung vì lý do an toàn.</li>
<li class="li2">Sử dụng Sản phẩm cho mục đích giám sát lén lút, theo dõi vị trí trái phép hoặc vi phạm quyền riêng tư của người khác.</li>
<li class="li2">Tải lên hoặc phát tán nội dung bất hợp pháp, độc hại, quấy rối, vi phạm bản quyền hoặc chứa mã độc/virus.</li>
<li class="li2">Dịch ngược, đảo ngược kỹ thuật (reverse-engineer) hoặc cố gắng chiếm đoạt mã nguồn độc quyền của hệ thống.</li>
<li class="li2">Sử dụng dữ liệu đầu ra từ AI của dịch vụ để huấn luyện hoặc phát triển các mô hình AI thương mại cạnh tranh.</li>
<li class="li2">Sử dụng bot, trình thu thập dữ liệu tự động trái phép trên hệ thống của Brilliant.</li>
</ul>
<p class="p2"><b>1.5 THÔNG BÁO VỀ DỮ LIỆU SINH TRẮC HỌC VÀ GHI ÂM/GHI HÌNH</b></p>
<p class="p2">BẠN XÁC NHẬN VÀ ĐỒNG Ý RẰNG THIẾT BỊ CÓ THỂ THU THẬP, XỬ LÝ ÂM THANH, HÌNH ẢNH HOẶC THÔNG TIN CẢM BIẾN ĐỂ THỰC HIỆN CÁC TÍNH NĂNG TƯƠNG TÁC AI. BẠN CHỊU TRÁCH NHIỆM TUÂN THỦ CÁC QUY ĐỊNH PHÁP LUẬT VỀ GHI ÂM, QUAY PHIM VÀ BẢO VỆ QUYỀN RIÊNG TƯ CỦA NHỮNG NGƯỜI XUNG QUANH KHI SỬ DỤNG THIẾT BỊ Ở NƠI CÔNG CỘNG.</p>
<p class="p2"><b>1.6 SỬA ĐỔI, TẠM NGỪNG VÀ CHẤM DỨT</b></p>
<p class="p2">Brilliant có quyền sửa đổi, giới hạn hoặc ngừng cung cấp bất kỳ tính năng hoặc dịch vụ nào vào bất kỳ lúc nào mà không cần báo trước. Việc tự ý can thiệp phần cứng trái phép sẽ làm mất hiệu lực bảo hành có giới hạn.</p>
<p class="p4"><b>2. QUYỀN SỞ HỮU; PHẦN MỀM VÀ DỊCH VỤ BÊN THỨ BA</b></p>
<p class="p2">Sản phẩm và Dịch vụ chứa đựng các thông tin độc quyền và quyền Sở hữu Trí tuệ của Brilliant Labs. Mọi nhãn hiệu, logo và thiết kế đều thuộc sở hữu của Brilliant hoặc các bên cấp phép tương ứng.</p>
<p class="p2">Dịch vụ có thể tích hợp API hoặc liên kết tới dịch vụ bên thứ ba (như các nhà cung cấp mô hình AI, xử lý ngôn ngữ). Brilliant không chịu trách nhiệm về nội dung, tính chính xác hay các chính sách riêng tư của các dịch vụ bên thứ ba này.</p>
<p class="p4"><b>3. NỘI DUNG NGƯỜI DÙNG VÀ PHẢN HỒI</b></p>
<p class="p2">Bạn giữ quyền sở hữu đối với Nội dung Người dùng do bạn tạo ra hoặc tải lên. Bằng việc cung cấp nội dung qua Dịch vụ, bạn cấp cho Brilliant giấy phép toàn cầu, miễn phí bản quyền để sử dụng, lưu trữ và xử lý nội dung đó nhằm mục đích cung cấp, duy trì và nâng cao chất lượng dịch vụ.</p>
<p class="p2">Mọi ý kiến đóng góp, đề xuất cải tiến (Feedback) gửi tới Brilliant sẽ được xem là không bảo mật và Brilliant có toàn quyền sử dụng, phát triển để hoàn thiện sản phẩm mà không phải chịu bất kỳ nghĩa vụ tài chính nào đối với bạn.</p>
<p class="p4"><b>4. CHẤP NHẬN RỦI RO; KHÔNG CẤU THÀNH TƯ VẤN CHUYÊN MÔN</b></p>
<p class="p2">Sản phẩm và Dịch vụ (bao gồm tác nhân AI Noa) được thiết kế cho mục đích thông tin tổng quát và hỗ trợ tiện ích. Dịch vụ KHÔNG cấu thành và không được sử dụng để thay thế cho tư vấn y tế, pháp lý, tài chính hoặc các tư vấn chuyên môn có chứng chỉ khác.</p>
<p class="p2">Bạn chịu hoàn toàn trách nhiệm trong việc đánh giá và xác thực các thông tin đầu ra từ AI trước khi đưa ra các quyết định quan trọng.</p>
<p class="p4"><b>5. TUYÊN BỐ TỪ CHỐI BẢO HÀNH</b></p>
<p class="p2">TRỪ KHI ĐƯỢC QUY ĐỊNH CỤ THỂ TRONG CHÍNH SÁCH BẢO HÀNH CÓ GIỚI HẠN CỦA PHẦN CỨNG, SẢN PHẨM VÀ DỊCH VỤ ĐƯỢC CUNG CẤP TRÊN NGUYÊN TẮC “NGUYÊN TRẠNG” (AS IS) VÀ “SẴN CÓ” (AS AVAILABLE). BRILLIANT TỪ CHỐI MỌI BẢO ĐẢM DÙ RÕ RÀNG HAY NGỤ Ý, BAO GỒM BẢO ĐẢM VỀ KHẢ NĂNG THƯƠNG MẠI, SỰ PHÙ HỢP CHO MỤC ĐÍCH CỤ THỂ HOẶC TÍNH KHÔNG VI PHẠM.</p>
<p class="p2">DO BẢN CHẤT XÁC SUẤT CỦA CÔNG NGHỆ TRÍ TUỆ NHÂN TẠO (AI) VÀ MÔ HÌNH HỌC MÁY (LLM), CHÚNG TÔI KHÔNG THỂ BẢO ĐẢM RẰNG CÂU TRẢ LỜI HOẶC NỘI DUNG DO AI TẠO RA LUÔN HOÀN TOÀN CHÍNH XÁC, ĐẦY ĐỦ HOẶC ĐÚNG THỰC TẾ.</p>
<p class="p4"><b>6. GIỚI HẠN TRÁCH NHIỆM</b></p>
<p class="p2">TRONG MỌI TRƯỜNG HỢP VÀ TRONG PHẠM VI TỐI ĐA ĐƯỢC PHÁP LUẬT CHO PHÉP, BRILLIANT VÀ CÁC ĐỐI TÁC SẼ KHÔNG CHỊU TRÁCH NHIỆM VỀ BẤT KỲ THIỆT HẠI GIÁN TIẾP, ĐẶC BIỆT, NGẪU NHIÊN HOẶC HỆ QUẢ NÀO (BAO GỒM MẤT LỢI NHUẬN, DỮ LIỆU HOẶC GIÁN ĐOẠN HOẠT ĐỘNG KINH DOANH). TỔNG TRÁCH NHIỆM PHÁP LÝ CỦA CHÚNG TÔI ĐỐI VỚI MỌI KHIẾU NẠI SẼ KHÔNG VƯỢT QUÁ SỐ TIỀN BẠN ĐÃ THANH TOÁN CHO SẢN PHẨM HOẶC DỊCH VỤ CỤ THỂ ĐÓ.</p>
<p class="p4"><b>7. BỒI THƯỜNG</b></p>
<p class="p2">Bạn đồng ý bảo vệ, bồi thường và giữ cho Brilliant, các chi nhánh, giám đốc, nhân viên và đối tác không bị tổn hại bởi bất kỳ khiếu nại, tổn thất, chi phí hoặc trách nhiệm nào phát sinh từ việc bạn vi phạm Điều khoản này hoặc vi phạm quyền của bất kỳ bên thứ ba nào.</p>
<p class="p4"><b>8. LUẬT ĐIỀU CHỈNH VÀ TRỌNG TÀI QUỐC TẾ</b></p>
<p class="p2">Điều khoản này và mọi tranh chấp phát sinh từ hoặc liên quan đến Sản phẩm hoặc Dịch vụ sẽ được điều chỉnh và giải thích theo luật pháp của <b>Singapore</b>.</p>
<p class="p2">Mọi tranh chấp sẽ được chuyển đến và giải quyết chung thẩm bằng trọng tài tại <b>Trung tâm Trọng tài Quốc tế Singapore (SIAC)</b> theo Quy tắc Trọng tài của SIAC đang có hiệu lực. Ngôn ngữ trọng tài là Tiếng Anh và địa điểm trọng tài là Singapore.</p>
<p class="p4"><b>9. ĐIỀU KHOẢN CHUNG VÀ LIÊN HỆ</b></p>
<p class="p2"><b>9.1 Thỏa thuận hoàn chỉnh:</b> Điều khoản này cùng với Chính sách Bảo mật cấu thành toàn bộ thỏa thuận giữa bạn và Brilliant Labs đối với việc sử dụng Sản phẩm và Dịch vụ.</p>
<p class="p2"><b>9.2 Tính hiệu lực từng phần:</b> Nếu bất kỳ điều khoản nào bị coi là không hợp lệ hoặc không thể thực thi, điều khoản đó sẽ được điều chỉnh ở mức tối thiểu cần thiết và các điều khoản còn lại vẫn giữ nguyên hiệu lực.</p>
<p class="p2"><b>9.3 Thông tin liên hệ:</b></p>
<p class="p1">Brilliant Labs Private Limited<br>68 Circular Road #02-01, 049422, Singapore<br>Email hỗ trợ &amp; Pháp lý: <a href="mailto:hello@brilliant.xyz" class="tw-text-white tw-underline">hello@brilliant.xyz</a></p>
    </div>
  </div>
