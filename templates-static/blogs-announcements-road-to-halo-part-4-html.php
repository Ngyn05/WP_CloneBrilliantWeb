...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-4/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
 ...
 &ndash; Brilliant Việt Nam</title><meta name="description" content="Hành trình đến Halo | Phần 4 💪🏼 Halo overcomes the false trade-off of privacy and open source. 🤗 We believe the next era of personal computing must be open while respecting your privacy. It must enable tremendous creativity while engendering trust. 🤘🏼 This makes the bar for innovation really high. It entails relinquishing con">
