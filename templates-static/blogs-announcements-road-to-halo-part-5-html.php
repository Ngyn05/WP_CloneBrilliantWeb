...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-5/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
...
<tbody>
<tr>
<td class="column-container-left column-container-right" align="center"><a href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/' ); ?>" rel="noopener" target="_blank"> <img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/shopify-email/fxlphgh05oomlqgwcfk1svexsrku.jpg?width=1200' ); ?>" class="image" width="480" height="221" alt="Brilliant Việt Nam"> </a></td>
</tr>
</tbody>
</table>
</td>
