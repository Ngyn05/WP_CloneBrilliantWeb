<?php
/** Static interface converted from pages/contact.html */
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"caa3a329-61dc-41fe-9c72-11dddc4f9e7d-1787126601","pageurl":"brilliant.xyz\/pages\/contact","s":"pages-111898296631","u":"a23ec8864b49","p":"page","rtyp":"page","rid":111898296631};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"364833c2-383d-4c83-a225-e19a02f8c32c"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"page","resourceType":"page","resourceId":111898296631,"requestId":"caa3a329-61dc-41fe-9c72-11dddc4f9e7d-1787126601","shopifyEmitted":true});
  ...
  <div class="container container--extra-narrow" data-aos="fade-up" style="max-width: 800px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6 tw-mb-12">
      <div class="tw-bg-[#161616] tw-border tw-border-[#2b2b2b] tw-rounded-2xl tw-p-6">
        <h3 class="tw-text-xl tw-font-semibold tw-text-white tw-mb-2">Hỗ trợ &amp; Khách hàng</h3>
        <p class="tw-text-[#999999] tw-text-sm tw-mb-4">Dành cho các câu hỏi về đơn hàng, thiết bị Halo và hỗ trợ kỹ thuật.</p>
        <a href="mailto:hello@brilliant.xyz" class="tw-text-white tw-underline hover:tw-text-[#d0bff5] tw-font-mono">hello@brilliant.xyz</a>
      </div>
      <div class="tw-bg-[#161616] tw-border tw-border-[#2b2b2b] tw-rounded-2xl tw-p-6">
        <h3 class="tw-text-xl tw-font-semibold tw-text-white tw-mb-2">Cộng đồng &amp; Hợp tác</h3>
        <p class="tw-text-[#999999] tw-text-sm tw-mb-4">Tham gia cộng đồng mã nguồn mở và kết nối trực tiếp với đội ngũ phát triển.</p>
        <div class="tw-flex tw-gap-4 tw-mt-2">
          <a href="https://discord.com/invite/vDS9X7gdwg" target="_blank" class="tw-text-white hover:tw-text-[#7289da] tw-font-medium">Discord</a>
          <span class="tw-text-[#444]">•</span>
          <a href="https://twitter.com/brilliantlabsar" target="_blank" class="tw-text-white hover:tw-text-[#1da1f2] tw-font-medium">Twitter / X</a>
          <span class="tw-text-[#444]">•</span>
          <a href="https://github.com/brilliantlabsAR" target="_blank" class="tw-text-white hover:tw-text-[#ffffff] tw-font-medium">GitHub</a>
        </div>
      </div>
    </div>
    ...
    <div class="tw-bg-[#161616] tw-border tw-border-[#2b2b2b] tw-rounded-2xl tw-p-8">
      ...
      <form class="tw-flex tw-flex-col tw-gap-5" onsubmit="event.preventDefault(); alert('Cảm ơn bạn đã gửi tin nhắn! Đội ngũ Brilliant Labs sẽ phản hồi bạn sớm nhất.');">
...
<link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/simplebar.min.css?v=21558511491353777691752050580' ); ?>" rel="stylesheet" type="text/css" media="all">
    ...
    </ul><script type="application/ld+json">
  {
    ...
    "url": "https:\/\/brilliant.xyz\/pages\/contact"
  }
