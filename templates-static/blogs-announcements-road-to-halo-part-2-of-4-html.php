<?php
/** Static interface converted from blogs/announcements/road-to-halo-part-2-of-4.html */
...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-2-of-4/' ) ); ?>">
  ...
  <script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/theme-4ed993c7.js' ); ?>" type="module" crossorigin="anonymous"></script>
    ...
    <title>
      Hành trình đến Halo | Phần 2
 &ndash; Brilliant Labs</title><meta name="description" content="Noa for Halo has taken a tremendous leap! 🥳🛠 We had a clear sense of what the right software experience should feel like. In line with advancements in AI speech technology, we set out to build a low-latency, multimodal conversational interface that felt like natural dialogue. a trusted friend who respects your privacy ">

<meta property="og:site_name" content="Brilliant Labs">
<meta property="og:url" content="https://brilliant.xyz/blogs/announcements/road-to-halo-part-2-of-4">
<meta property="og:title" content="Hành trình đến Halo | Phần 2">
<meta property="og:type" content="article">
<meta property="og:description" content="Noa for Halo has taken a tremendous leap! 🥳🛠 We had a clear sense of what the right software experience should feel like. In line with advancements in AI speech technology, we set out to build a low-latency, multimodal conversational interface that felt like natural dialogue. a trusted friend who respects your privacy "><meta property="og:image" content="http://brilliant.xyz/cdn/shop/articles/IMG_7016.jpg?v=1755644717">
  <meta property="og:image:secure_url" content="https://brilliant.xyz/cdn/shop/articles/IMG_7016.jpg?v=1755644717">
  <meta property="og:image:width" content="2316">
  <meta property="og:image:height" content="3088"><meta name="twitter:site" content="@brilliantlabsar"><meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Hành trình đến Halo | Phần 2">
<meta name="twitter:description" content="Noa for Halo has taken a tremendous leap! 🥳🛠 We had a clear sense of what the right software experience should feel like. In line with advancements in AI speech technology, we set out to build a low-latency, multimodal conversational interface that felt like natural dialogue. a trusted friend who respects your privacy ">
<script>
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"1ab41980-45ab-4848-ab60-b4c7e8a87993-1787127422","pageurl":"brilliant.xyz\/blogs\/announcements\/road-to-halo-part-2-of-4","s":"articles-610177712439","u":"886ad67f602d","p":"article","rtyp":"article","rid":610177712439};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"article","resourceType":"article","resourceId":610177712439,"requestId":"1ab41980-45ab-4848-ab60-b4c7e8a87993-1787127422","shopifyEmitted":true});
...
<div class="hero hero--template--24820771455287__article-hero hero--grid hero--mobile-small hero--image-right hero--has-logo   hero--share-button"><mobile-reversed-logo class="hero__logo text-center d-lg-none">
  ...
  <path d="M9 7H11L12 12H1L2 7H4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <div class="share-button__content">
      ...
      <input type="text" class="share-button__input d-none" id="url" value="https://brilliant.xyz/blogs/announcements/road-to-halo-part-2-of-4" placeholder="Liên kết" onclick="this.select();" readonly="" data-share-button-url-input="">
...
" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016.jpg?v=1755644717' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-1.jpg' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-2.jpg' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-3.jpg' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-4.jpg' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-5.jpg' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-6.jpg' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-7.jpg' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-8.jpg' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-9.jpg' ); ?> 1728w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-10.jpg' ); ?> 1944w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/IMG_7016-11.jpg' ); ?> 2160w" sizes="(min-width: 1025px) 700px" alt="Hành trình đến Halo " loading="lazy" width="2316" height="3088"></div>
          </div>
</div>
  </div>
...
<strong><span>Noa</span></strong> dành cho <strong><span>Halo</span></strong> đã có một bước tiến vượt bậc! 🥳🛠<meta charset="utf-8">
</h3>
...
<div style="text-align: center;"><img style="margin-right: 20px; margin-bottom: 16px; margin-left: 20px; float: none;" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/s/files/1/0722/5190/0215/files/Noa_b7a5850a-1ab2-4d95-99dd-9c6ce6330354_1024x1024.png?v=1753743650' ); ?>" width="286" height="103"></div>
<h4 style="text-align: center;">
<strong><span>Một người bạn đáng tin cậy luôn tôn trọng quyền riêng tư của bạn</span></strong><span> — </span><span>với khả năng xử lý suy luận trực tiếp trên thiết bị sắp ra mắt</span>
</h4>
...
<p> </p>
<div style="text-align: center;"><a href="https://youtu.be/dKL9atC5-7w" title="Memory Demo edit fun"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/s/files/1/0722/5190/0215/files/IMG_3252_fde61162-01dd-4052-9c82-2f6d1bb05aa6_600x600.jpg?v=1753934700' ); ?>" style="margin-bottom: 16px; float: none;"></a></div>
<p> </p>
...
<p> </p>
<div style="text-align: center;"><a href="https://youtu.be/QVe9kLore_I" title="Demo Noa in the Garden"><img src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/s/files/1/0722/5190/0215/files/garden_1024x1024.png?v=1755545742' ); ?>" style="margin-bottom: 16px; float: none;"></a></div>
<h5>Giao diện người dùng UI/UX trên <strong><span>Halo</span></strong> và trong ứng dụng di động được thiết kế với phong cách hoài niệm cổ điển (retro vibes), gắn liền với thời kỳ khởi đầu của máy tính cá nhân, máy chơi game arcade và internet sơ khai.<strong><br></strong>
</h5>
...
<p><br></p>
...
</article><script type="application/ld+json">
  {
    ...
    "@type": "Article",
    "articleBody": "\nNoa for Halo has taken a tremendous leap! 🥳🛠\n\n\nWe had a clear sense of what the right software experience should feel like. In line with advancements in AI speech technology, we set out to build a low-latency, multimodal conversational interface that felt like natural dialogue.\n\n\na trusted friend who respects your privacy — with on-device inference on the horizon\n\n🧠👀But there is one more thing which has been on our mind for a while: **MEMORY** — a pillar of the human experience and a growing requirement for intelligent technologies. \n(Click Image Below for Demo👇)\n \n\n \nUnlike prevailing memory solutions which are oriented toward written text, we felt we could make a contribution to this space by designing Noa’s memory to learn from the challenging contours of daily life — what you see, hear, and say — while discerning useful signal from the abundance of noise. \n🤯The prospect of a private, trusted agent reasoning over years of the life you live opens previously unimaginable possibilities. \n(Click Image Below for Demo 2👇)\n \n\nUI\/UX on Halo and in the mobile app is set for a dramatic twist: back to our childhood of retro vibes coinciding with the emergence of personal computing, arcade games, and the early internet.\n\nStay tuned 😎\n",
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https:\/\/brilliant.xyz"
    },
    "headline": "Hành trình đến Halo | Phần 2","image": [
        "https:\/\/brilliant.xyz\/cdn\/shop\/articles\/IMG_7016.jpg?v=1755644717\u0026width=2316"
      ],"datePublished": "2025-08-20T07:00:38Z",
    "dateCreated": "2025-08-19T05:17:47Z",
    "author": {
      "@type": "Person",
      "name": "Sam Khorshid"
    },
