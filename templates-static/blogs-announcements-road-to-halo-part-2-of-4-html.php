...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-2-of-4/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
...
<div class="hero hero--template--24820771455287__article-hero hero--grid hero--mobile-small hero--image-right hero--has-logo   hero--share-button"><mobile-reversed-logo class="hero__logo text-center d-lg-none">
      <a class="hero__logo-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Brilliant Việt Nam" data-mobile-reversed-logo-link=""></a>
