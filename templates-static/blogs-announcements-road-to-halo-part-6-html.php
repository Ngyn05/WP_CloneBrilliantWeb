...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-6/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
...
<tbody>
<tr>
<td align="center"><a rel="noopener" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/' ); ?>" target="_blank"> <img alt="Brilliant Việt Nam" height="345" width="480" class="image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/shopify-email/r7nzqrgjq5tlbzy6nslynkmuuxys.jpg?width=1200' ); ?>"> </a></td>
</tr>
</tbody>
</table>
</td>
