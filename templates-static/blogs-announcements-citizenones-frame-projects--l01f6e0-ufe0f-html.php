...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/citizenones-frame-projects/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
  ...
  <script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/theme-4ed993c7.js' ); ?>" type="module" crossorigin="anonymous"></script>
    ...
    <title>
      Các dự án Frame của CitizenOne &ndash; Brilliant Việt Nam</title><meta name="description" content="Khám phá các dự án mã nguồn mở ấn tượng cho kính thông minh Frame từ nhà phát triển CitizenOne: Ghim vị trí AR trực tiếp, Generative AI tạo ảnh và Trình hiển thị Sprite 16-bit.">
