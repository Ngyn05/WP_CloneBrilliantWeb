...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/citizenones-frame-projects/' ) ); ?>">
  ...
  <script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/theme-4ed993c7.js' ); ?>" type="module" crossorigin="anonymous"></script>
    ...
    <title>
      Các dự án Frame của CitizenOne &ndash; Brilliant Labs</title><meta name="description" content="Khám phá các dự án mã nguồn mở ấn tượng cho kính thông minh Frame từ nhà phát triển CitizenOne: Ghim vị trí AR trực tiếp, Generative AI tạo ảnh và Trình hiển thị Sprite 16-bit.">

<meta property="og:site_name" content="Brilliant Labs">
<meta property="og:url" content="https://brilliant.xyz/blogs/announcements/citizenones-frame-projects-%f0%9f%9b%a0%ef%b8%8f">
<meta property="og:title" content="CitizenOne&#39;s Frame Projects">
<meta property="og:type" content="article">
<meta property="og:description" content="AR Live Location Pin Demo Overlays AR location / navigation pins representing multiple points of interest (POIs) into the field of view. Uses Frame&#39;s onboard magnetometer and accelerometer data streamed to the phone to calculate and update the bearing to each POI.Currently uses hard-coded sample latitude/longitude coor"><meta property="og:image" content="http://brilliant.xyz/cdn/shop/articles/frameshot1.webp?v=1732103247">
  <meta property="og:image:secure_url" content="https://brilliant.xyz/cdn/shop/articles/frameshot1.webp?v=1732103247">
  <meta property="og:image:width" content="928">
  <meta property="og:image:height" content="751"><meta name="twitter:site" content="@brilliantlabsar"><meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="CitizenOne&#39;s Frame Projects">
<meta name="twitter:description" content="AR Live Location Pin Demo Overlays AR location / navigation pins representing multiple points of interest (POIs) into the field of view. Uses Frame&#39;s onboard magnetometer and accelerometer data streamed to the phone to calculate and update the bearing to each POI.Currently uses hard-coded sample latitude/longitude coor">
<script>
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"5f6066c5-691e-4fe5-88f7-d814442261e9-1787130569","pageurl":"brilliant.xyz\/blogs\/announcements\/citizenones-frame-projects-%F0%9F%9B%A0%EF%B8%8F","s":"articles-608820756791","u":"fcf28c5bd1f7","p":"article","rtyp":"article","rid":608820756791};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"1de1f4f2-f498-4dd8-85e4-95f83a34312a"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"article","resourceType":"article","resourceId":608820756791,"requestId":"5f6066c5-691e-4fe5-88f7-d814442261e9-1787130569","shopifyEmitted":true});
...
<div class="hero hero--template--24820771455287__article-hero hero--grid hero--mobile-small hero--image-right hero--has-logo   hero--share-button"><mobile-reversed-logo class="hero__logo text-center d-lg-none">
  ...
  <path d="M9 7H11L12 12H1L2 7H4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <div class="share-button__content">
      ...
      <input type="text" class="share-button__input d-none" id="url" value="https://brilliant.xyz/blogs/announcements/citizenones-frame-projects-%F0%9F%9B%A0%EF%B8%8F" placeholder="Liên kết" onclick="this.select();" readonly="" data-share-button-url-input="">
...
" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp?v=1732103247' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-3.webp' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-4.webp' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp' ); ?> 720w" sizes="100vw" alt="Các dự án Frame của CitizenOne" loading="lazy" width="928" height="751"></div>

            <div class="hero__image-wrapper d-none d-md-block"><img class="hero__image hero__image--small
" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp?v=1732103247' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-1.webp' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-2.webp' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-3.webp' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-4.webp' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/frameshot1-5.webp' ); ?> 720w" sizes="(min-width: 1025px) 700px" alt="Các dự án Frame của CitizenOne" loading="lazy" width="928" height="751"></div>
          </div>
</div>
  </div>
