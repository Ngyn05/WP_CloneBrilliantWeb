...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements/road-to-halo-part-3-of-4/' ) ); ?><link rel="icon" type="image/png" sizes="32x32" href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/files/favicon-32x32.png?v=3' ); ?>">
 ...
 &ndash; Brilliant Việt Nam</title><meta name="description" content="🎨Our work on Halo’s hardware required intentionality and restraint, clarity of purpose, and intensive design across every level of the stack.  🙄You may have noticed that nearly every other pair of smart glasses coming to market is following a predictable path.  But we are thinking different: these devices are not for s">
