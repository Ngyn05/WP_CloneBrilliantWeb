<?php
/** Static interface converted from blogs/announcements-1.html */
...
<html class="no-js" lang="vi">
  <head>
    ...
    <link rel="canonical" href="<?php echo esc_url( home_url( '/blogs/announcements-1/?page=2' ) ); ?>">
  ...
  <script src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/theme-4ed993c7.js' ); ?>" type="module" crossorigin="anonymous"></script>
    ...
    <title>
      Thông báo
 &ndash; Page 2 &ndash; Brilliant Labs</title>

<meta property="og:site_name" content="Brilliant Labs">
<meta property="og:url" content="https://brilliant.xyz/blogs/announcements?page=2">
...
<link rel="prev" href="<?php echo esc_url( home_url( '/blogs/announcements-2/?page=1' ) ); ?>">
...
<script id="__st">var __st={"a":72251900215,"offset":28800,"reqid":"7ad65620-6cea-40b7-b7eb-d766c3b0b671-1787127412","pageurl":"brilliant.xyz\/blogs\/announcements?page=2","s":"blogs-113034559799","u":"db205efe9130","p":"blog","rtyp":"blog","rid":113034559799};</script>
...
first.parentNode.insertBefore(script, first);
    ...
    trekkie.load(
      {"Trekkie":{"appName":"storefront","development":false,"defaultAttributes":{"shopId":72251900215,"isMerchantRequest":null,"themeId":179256688951,"themeCityHash":"5630027833518771883","contentLanguage":"en","currency":"USD","eventMetadataId":"f0deba10-fb77-4ad4-bbc0-c621fd2c8796"},"isServerSideCookieWritingEnabled":true,"monorailRegion":"shop_domain","enabledBetaFlags":["f43e7f5e","b5387b81","d5bdd5d0"]},"Session Attribution":{},"S2S":{"facebookCapiEnabled":true,"source":"trekkie-storefront-renderer","apiClientId":580111}}
    );
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"blog","resourceType":"blog","resourceId":113034559799,"requestId":"7ad65620-6cea-40b7-b7eb-d766c3b0b671-1787127412","shopifyEmitted":true});
...
<div class="blog blog--template--24820771684663__main main-section">
  ...
  <a class="image-link color-text hover-effect--zoom" href="<?php echo esc_url( home_url( '/blogs/announcements/hackathon-august-3rd-2024/' ) ); ?>" title="Hackathon: Ngày 3 tháng 8 năm 2024">
    <div class="row row--align-center"><div class="col-12 col-md-6">
          <div class="article-card__image-wrapper  image-ratio--square"><img class="article-card__image hover-effect__image" src="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-15.jpg?v=1728988033' ); ?>" srcset="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-1.jpg' ); ?> 100w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-2.jpg' ); ?> 180w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-3.jpg' ); ?> 360w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-4.jpg' ); ?> 540w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-5.jpg' ); ?> 720w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-6.jpg' ); ?> 1080w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-7.jpg' ); ?> 1296w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-8.jpg' ); ?> 1512w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-9.jpg' ); ?> 1728w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-10.jpg' ); ?> 1944w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-11.jpg' ); ?> 2160w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-12.jpg' ); ?> 2376w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-13.jpg' ); ?> 2592w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-14.jpg' ); ?> 2808w, <?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/articles/Frame_hackathon_v001-15.jpg' ); ?> 3024w" sizes="(max-width: 767px) 100vw, (max-width: 1024px) 50vw, 700px" alt="Hackathon: Ngày 3 tháng 8 năm 2024" loading="lazy" width="3909" height="2353"></div>
        </div><div class="article-card__content col-12 col-md-6 text-left"><p class="article-card__title h4 d-md-none">Hackathon: Ngày 3 tháng 8 năm 2024
</p><p class="article-card__title h2 d-none d-md-block">Hackathon: Ngày 3 tháng 8 năm 2024
</p><p class="article-card__excerpt">
            Chúng tôi rất vinh dự được đồng tổ chức sự kiện Hackathon cùng Niantic, nhà sáng tạo của tựa game Pokémon Go nổi tiếng!
          </p><p>10/10/2024
...
</div></div></div><div class="row"></div><link href="<?php echo esc_url( get_template_directory_uri() . '/site-assets/cdn/shop/t/24/assets/component-pagination.css?v=36509695587630536881752050579' ); ?>" rel="stylesheet" type="text/css" media="all">
<div class="pagination-wrapper">
    <nav class="pagination" role="navigation" aria-label="Pagination">
      <ul class="pagination__list" role="list"><li>
          <a class="pagination__item pagination__item--prev pagination__item--no-hover" href="<?php echo esc_url( home_url( '/blogs/announcements-2/?page=1' ) ); ?>" aria-label="Previous page"><svg class="icon icon-arrow-left-small" aria-hidden="true" focusable="false" role="presentation" width="14" height="11" viewbox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M0.707092 5.16257L5.05171 9.60538M0.707092 5.16257L5.00965 0.602692M0.707092 5.16257L12.7071 5.09427" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
</svg></a>
        </li><li><a class="pagination__item color-foreground" href="<?php echo esc_url( home_url( '/blogs/announcements-2/?page=1' ) ); ?>" aria-label="Page 1">
              1
            </a></li><li><a class="pagination__item pagination__item--current" role="link" aria-disabled="true" aria-current="page" aria-label="Page 2">
                2
              </a></li></ul>
    </nav>
  </div></div>
